...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "MilkSwap home page" },
            React.createElement("img", { src: "https://github.com/fruitdexe/pancake-uikit/blob/main/src/widgets/Menu/logo.png?raw=true", alt: "FruitDex Logo", className: "mobile-icon" }),
            React.createElement("img", { src: "https://github.com/fruitdexe/pancake-uikit/blob/main/src/widgets/Menu/11logo.png?raw=true", alt: "FruitDex Logo", className: "desktop-icon" }))) : (React.createElement(StyledLink$1, { to: href, "aria-label": "MilkSwap home page" },
            React.createElement("img", { src: "https://github.com/fruitdexe/pancake-uikit/blob/main/src/widgets/Menu/logo.png?raw=true", alt: "FruitDex Logo", className: "mobile-icon" }),
            React.createElement("img", { src: "https://github.com/fruitdexe/pancake-uikit/blob/main/src/widgets/Menu/11logo.png?raw=true", alt: "FruitDex Logo", className: "desktop-icon" })))));
};

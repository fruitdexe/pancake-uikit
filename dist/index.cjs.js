...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "MilkSwap home page" },
            React__default['default'].createElement("img", { src: "https://github.com/fruitdexe/pancake-uikit/blob/main/src/widgets/Menu/logo.png?raw=true", alt: "FruitDex Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://github.com/fruitdexe/pancake-uikit/blob/main/src/widgets/Menu/11logo.png?raw=true", alt: "FruitDex Logo", className: "desktop-icon" }))) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "MilkSwap home page" },
            React__default['default'].createElement("img", { src: "https://github.com/fruitdexe/pancake-uikit/blob/main/src/widgets/Menu/logo.png?raw=true", alt: "FruitDex Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://github.com/fruitdexe/pancake-uikit/blob/main/src/widgets/Menu/11logo.png?raw=true", alt: "FruitDex Logo", className: "desktop-icon" })))));
};
